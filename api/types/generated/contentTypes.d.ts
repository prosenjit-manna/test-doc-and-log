...
export interface ApiAppModuleAppModule extends Schema.CollectionType {
...
export interface ApiTestCaseTestCase extends Schema.CollectionType {
  ...
  attributes: {
    ...
    State: Attribute.Enumeration<['Active ', 'Draft ', 'Retried ']> &
      Attribute.Required &
      Attribute.DefaultTo<'Draft '>;
    estimation: Attribute.String;
    priority: Attribute.Enumeration<['High', 'Medium', 'Low']>;
    Expected: Attribute.Blocks;
    Attachments: Attribute.Media;
    test_plans: Attribute.Relation<
      'api::test-case.test-case',
      'manyToMany',
      'api::test-plan.test-plan'
    >;
    test_histories: Attribute.Relation<
      'api::test-case.test-case',
      'oneToMany',
      'api::test-history.test-history'
    >;
    app_modules: Attribute.Relation<
      'api::test-case.test-case',
      'manyToMany',
      'api::app-module.app-module'
    >;
...
export interface ApiTestHistoryTestHistory extends Schema.CollectionType {
...
export interface ApiTestPlanTestPlan extends Schema.CollectionType {
